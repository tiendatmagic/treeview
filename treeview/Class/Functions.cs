...
namespace treeview.Class
{
    class Functions
    {
        ...
        {
            conn = new SqlConnection("Data Source=ADMIN\\SQLEXPRESS;Initial Catalog=QuanLySach;Integrated Security=True");
            conn.Open();
        ...
        public static string ChuyenSoSangChu(string sNumber)
        {
            ...
            for (int i = 0; i <= mLen; i++)
            {
                ...
                switch ((mLen - i) % 9)
                {
                    ...
                    case 6:
                        mTemp = mTemp + " triệu";
                        if (sNumber.Substring(i + 1, 3) == "000") i = i + 3; if (sNumber.Substring(i + 1, 3) == "000") i = i + 3;
                        break;
                    case 3:
                        mTemp = mTemp + " nghìn";
                        if (sNumber.Substring(i + 1, 3) == "000") i = i + 3;
